...
alias jira='python3 "$HOME/mytools/jira.py"'
alias trello='python3 "$HOME/mytools/trello.py"'
alias bible-verse='python3 "$HOME/mytools/bible-verse.py"'
alias csvimport='python3 "$HOME/mytools/csvimport.py"'